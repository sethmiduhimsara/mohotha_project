...
import OpenGoogleSheetButton from "./OpenGoogleSheetButton";
      ...
      <header className="border-b border-[#E8DCC8] bg-white px-6 py-5 shadow-sm">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          <div>
            ...
            >
              {client?.displayName ?? "Wedding Invitation"} · RSVP Dashboard
            </h1>
          </div>
      ...
      <main className="mx-auto max-w-7xl px-6 py-10">
        {client?.googleSheetId ? (
          ...
          <p className="mb-8 rounded-xl border border-[#E8DCC8] bg-white px-4 py-3 text-sm text-[#a05050]">
            ...
            as Editor, then run{" "}
            <code className="text-xs">npm run link:sheet -- wedding-invitation SHEET_ID</code>.
          </p>
        )}
